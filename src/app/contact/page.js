  ...
  useEffect(() => {
    ...
    if (submitButton) {
      submitButton.addEventListener('mouseenter', () => {
        animate(submitButton, { scale: 1.03 }, { duration: 0.2 });
      });
        ...
        >
          <div className="bg-white dark:bg-black/20 rounded-xl shadow-md p-8">
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="submit-button w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors"
              >
                Send Message
              </button>
            </form>
